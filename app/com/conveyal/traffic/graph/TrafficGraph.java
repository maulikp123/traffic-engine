...
public class TrafficGraph {
	...
	public StreetEdge getEdgeFromCoord(ProjectedCoordinate coord) {
		CandidateEdgeBundle fromEdges = indexService.getClosestEdges(coord.getReferenceLatLon(), defaultOptions, null, null, true);
		StreetEdge edge = fromEdges.best.edge;
		return edge;
	}
	
//	Added by Maulik for test
	public Integer getEdgeId(Edge edge) {
		return graph.getIdForEdge(edge);
	}
}
